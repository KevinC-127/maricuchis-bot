...
from telegram.ext import Application, ApplicationBuilder, CommandHandler, MessageHandler, CallbackQueryHandler, ConversationHandler, ContextTypes, filters, TypeHandler
...
BOLETO_CLIENTE, BOLETO_CANTIDAD, BOLETO_ASUNTO = 50, 51, 52
